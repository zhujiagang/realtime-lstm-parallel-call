...
def main():
    ...
    if args.Finetune_SSD is True:
        ...
        if os.path.isfile(args.resume):
            ...
            # model_dict = net.state_dict()  # 1. filter out unnecessary keys
            # pretrained_dict_2 = {k.split("module.")[-1]: v for k, v in pretrained_dict.items() if k.split("module.")[-1] in model_dict}  # 2. overwrite entries in the existing state dict
